window.onload = function() {
    ...
    var media_p_sub = document.querySelectorAll('.media_p_sub>a')[0];
    contect_show(media_p_sub);
    var HE_contect = document.querySelectorAll('.HE_contect>li')[0];
    contect_show(HE_contect);
    
}

function media_submenu(i) {
    var scrollcontect1 = document.getElementsByClassName('AB_contect1')[0];
    var scrollcontect2 = document.getElementsByClassName('AB_contect2')[0];
    ...
    i[1].onclick = function () {
        window.scrollTo({
            top: scrollcontect1.offsetTop,
            behavior: "smooth"
        });
    }
    i[2].onclick = function () {
        window.scrollTo({
            top: scrollcontect2.offsetTop,
            behavior: "smooth"
        });
    }
}
